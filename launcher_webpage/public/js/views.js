...
try {
  ...
  with (locals || {}) {
    ; __append("<form>\n    <div class=\"form-item\">\n        <label for=\"terrain\">Choose your terrain:</label>\n        <select name=\"terrain\" id=\"terrain\">\n            <option value=\"choose\">Choose</option>\n            <option value=\"new_york\">New York</option>\n            <option value=\"santorini\">Santorini</option>\n            <option value=\"tokyo\">Tokyo</option>\n            <option value=\"neom\">Neom</option>\n        </select>\n    </div>\n    <div class=\"form-item\">\n        <label for=\"level\">Choose the difficulty:</label>\n        <select name=\"level\" id=\"level\">\n            <option value=\"choose\">Choose</option>\n            <option value=\"easy\">Easy</option>\n            <option value=\"medium\">Medium</option>\n            <option value=\"hard\">Hard</option>\n        </select>\n    </div>\n</form>\n\n")
    ; __line = 23
    ; __append( include('includes/launcher') )
  }
  return __output;
} catch (e) {
...
ejs.views_includes_launcher = function(locals, escapeFn, include = ejs.views_include(locals), rethrow
) {
rethrow = rethrow || function rethrow(err, str, flnm, lineno, esc) {
  var lines = str.split('\n');
  var start = Math.max(lineno - 3, 0);
